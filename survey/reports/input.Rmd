...
The life form `r spp_name` is known commonly as `r spp_common$'COMMON NAME' `.
...
The range of longitude over which this species is found is `r round(spp_dist_coords$lon_west, 2)`°E to `r round(spp_dist_coords$lon_east, 2)`°E.
