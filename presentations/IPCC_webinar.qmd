...
## {background-color="#e5e5e5" transition="fade"}
...
![](kd_full.png){.absolute top="0" left="100"}

## {background-color="#e5e5e5" transition="fade"}

![](../figures/LOV_fig_1B.png){.absolute top="0" left="100"}

## Takeaway

::: incremental
-   As the planet warms the cryosphere will melt
-   Removes one entire category of the socio-ecological system
-   Will no longer be "Arctic"
:::
