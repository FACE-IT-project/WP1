...
![](../logo/Logo_FACE-IT_PNG_1500.png){style="width: 350px; height: 200px; margin: 10px;" .absolute top="80" left="40" angle="45"}
...
```{r}
knitr::kable(data.frame(Category = c("Cryosphere", "Physics", "Biology", "Chemistry", "Social")), 
             caption = "Table 1: The categories for drivers of changes for Arctic fjords.")  |>  
