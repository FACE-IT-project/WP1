...
![](../logo/Logo_Xiamen%20University.png){width="160"} ![](../logo/Logo_Aalborg University.png){width="90"} ![](../logo/Logo_Aarhus University.png){width="110"} ![](../logo/Logo_CMN.png){width="110"} ![](../logo/Logo_Nordland Research Institute.png){width="100"} ![](../logo/Logo_Shenzhen University.png){width="80"} ![](../logo/Logo_Utrecht University.png){width="130"}
...
::: {.fragment .fade-right}
<div style="text-align:right;font-weight:bold"> <font color="white"> Make data openly accessible within and outside of FACE-IT. </font> </div>
:::
...
::: {.fragment .fade-left}
<div style="font-weight:bold"> <font color="white"> Archival of all FACE-IT data in FAIR repositories. </font> </div>
:::

::: {.fragment .fade-right}
<div style="font-weight:bold"> <font color="white">  Further analyses and publications. </font> </div>
:::

## Improvements {.scrollable}
