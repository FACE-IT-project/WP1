...
* `r nrow(socat_arctic)` in the Arctic Ocean shelf waters (shallower than 200 m), or `r round(100*nrow(socat_arctic)/nrow(socat_all), digits = 1)`% of the global number of records
