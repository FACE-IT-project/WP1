...
# Bind them together
metadata_svalbard <- rbind(svalbard_paeb, svalbard_odma, svalbard_nwmmcalanus, svalbard_nwtotcalanus, svalbard_semmcalanus, svalbard_setotcalanus, svalbard_ritr)
```
...
# Bind them together
metadata_isfjorden <- rbind(is_ritr)
```
