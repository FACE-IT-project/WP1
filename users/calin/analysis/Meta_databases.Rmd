...
kong_urlo <- data.frame(type = "CTD",
                         ...
                         citation = '<a onclick="alert(\'Norwegian Polar Institute (2022). Brünnich’s guillemot breeding populations, percentage of colony average. Environmental monitoring of Svalbard and Jan Mayen (MOSJ). URL: http://www.mosj.no/en/fauna/marine/brunnichs-guillemot.html\');">NPI (2022)</a>',
                         note = NA)
...
svalbard_ritr <- data.frame(type = "CTD",
                         data_name = "Biomass: rissa tridactyla (black-legged kittiwake)",
                         date_range = "1988 to 2021",
                         URL = '<a target="_blank" rel="noopener noreferrer" href="https://mosj.no/en/indikator/fauna/marine-fauna/black-legged-kittiwake//">MOSJ</a>',
                         citation = '<a onclick="alert(\'Norwegian Polar Institute (2022). Black-legged kittiwake population size, as percentage of the average in the colony. Environmental monitoring of Svalbard and Jan Mayen (MOSJ). URL: http://www.mosj.no/en/fauna/marine/black-legged-kittiwake.html\');">NPI (2022)</a>',
...
svalbard_urlo <- data.frame(type = "CTD",
                         data_name = "Biomass: Uria lomvia (brünnich’s guillemot)",
                         date_range = "1988 to 2021",
                         URL = '<a target="_blank" rel="noopener noreferrer" href="https://mosj.no/en/indikator/fauna/marine-fauna/brunnichs-guillemot/">MOSJ</a>',
                         citation = '<a onclick="alert(\'Norwegian Polar Institute (2022). Brünnich’s guillemot breeding populations, percentage of colony average. Environmental monitoring of Svalbard and Jan Mayen (MOSJ). URL: http://www.mosj.no/en/fauna/marine/brunnichs-guillemot.html\');">NPI (2022)</a>',
...
# Bind them together
metadata_svalbard <- rbind(svalbard_paeb, svalbard_odma, svalbard_nwmmcalanus, svalbard_nwtotcalanus, svalbard_semmcalanus, svalbard_setotcalanus, svalbard_ritr, svalbard_urlo)
```
