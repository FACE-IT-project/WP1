...
# svalbard calanus population (north and west)
svalbard_nwcalanus <- data.frame(type = "CTD",
...
# Bind them together
metadata_svalbard <- rbind(svalbard_paeb, svalbard_odma, svalbard_nwcalanus)
```
