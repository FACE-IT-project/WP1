...
# Analyses ----------------------------------------------------------------
load('users/calin/data/NUUP_1_n.RData')
load('users/calin/data/NUUP_2_n.RData')
load('users/calin/data/YOUNG_1_n.RData')
load('users/calin/data/YOUNG_2_n.RData')
...
DATA1 <- dcast(NUUP_1_n, Year ~ Taxon, sum, value.var = "Density") # create cross table
...
DATA1_Turnover <- turnover(NUUP_1_n, time.var = "Year", species.var = "Taxon", abundance.var = "Density" , metric = "total")
