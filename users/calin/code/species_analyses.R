...
DATA1 <- dcast(clean_sva_cycr_pop, Year ~ Taxon, sum, value.var = "Density") # create cross table
...
DATA1_Turnover <- turnover(clean_sva_cycr_pop, time.var = "Year", species.var = "Taxon", abundance.var = "Density" , metric = "total")
