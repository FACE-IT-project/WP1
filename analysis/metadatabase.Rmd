...
Figure 1: FACE-IT study sites throughout the EU Arctic. The light blue bounding box (appears here as a triangle due to polar projection) shows the spatial range within which data were considered for collection.
</center>
<br>
...
<center>
![](assets/map_svalbard.png){ width=90% }

Figure 2: Map of Svalbard showing the location of the three FACE-IT study sites located on the archipelago.
</center>
<br>
...
sval_glacier_mass <- data.frame(type = "Survey",
...
# Combine
metadata_svalbard <- rbind(sval_glacier_mass, sval_glacier_area, sval_tidal_glacier_front, sval_marine_glacier_front, sval_tidewater_ablation,
                           sval_surface_met, sval_UNIS_database, sval_seabird_database, sval_protection, sval_NICE, 
                           sval_fast, sval_biogeochemistry, sval_pop, sval_tour_arrival, sval_guest_night, sval_AIS)
```
...
metadata_kongsfjorden <- rbind(kong_sea_ice_inner, kong_zoo_data, kong_protist_nutrient_chla, kong_CTD_database, 
                               ...
                               kong_ferry, kong_MOSJ, kong_pavlov, kong_bischoff, kong_bartsch, kong_hanelt, kong_TWICE, kong_mooring_SAMS,
                               kong_macroalgae, kong_benthic, kong_ship_arrivals, kong_NOAA, kong_CCI, kong_MASIE, 
                               kong_SOCAT, kong_PG, full_product_kong)
```
