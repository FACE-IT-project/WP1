...
is_PG <- data.frame(type = "PANGAEA",
                    ...
                    file_name = '<a onclick="alert(\'pg_is_ALL.csv\');">1 file</a>',
                    URL = '<a onclick="alert(\'pg_is_ALL.csv\');">See URL column</a>',
                    reference = '<a onclick="alert(\'pg_is_ALL.csv\');">See citation column</a>',
                    note = "This is a combination of all PANGAEA data.")
...
metadata_isfjorden <- rbind(is_mooring_N, is_mooring_S, is_mooring_IFO, is_mooring_GFI_N, is_mooring_GFI_S, is_CO2_tempelfjorden, 
                            is_CO2_IsA, is_Chla_IsA, is_met_radio, is_met_airport, is_met_pyramiden)
```
