...
por_sea_ice <- data.frame(type = "Satellite",
                          ...
                          reference = '<a onclick="alert(\'Megan O\'Sadnick, Chris Petrich, Camilla Brekke, & Jofrid Skardhamar. (2020). Ice extent in Norwegian fjords, 2001-2019 [Data set]. In Annals of Glaciology (1.0.1, Number Sea Ice at the Interface). Zenodo. https://doi.org/10.5281/zenodo.4133926\');">O\'Sadnick et al. (2020)</a>',
                          note = NA)
...
# Bind them together
metadata_porsangerfjorden <- rbind(por_mooring_GFI, por_fish_bio, por_benthos_bio, por_NorKyst, por_sea_ice, por_PG, full_product_por)
```
