...
sval_tidal_glacier_front <- data.frame(data_type = "Tidal glacier front",
                                ...
                                reference = "Kohler, J., König, M., Nuth, C., & Villaflor, G. (2018). 
                                Svalbard tidewater glacier front database [Data set]. Norwegian Polar Institute.
                                https://doi.org/10.21334/npolar.2018.7cd67b1a",
                                note = NA)
...
DT::datatable(metadata_svalbard, rownames = FALSE, filter = "top", options = list(pageLength = 5, scrollX = T), 
...
knitr::kable(data.frame(Category = c("Physical", "Physical", 
                                     "Physical", "Cryosphere", "Cryoshpere"),
                        Driver = c("Longwave radiation (Q_lw)", "Shortwave radiation (Q_sw)", 
                                   "turbidity", "Land glacier mass balance", "Runoff")))
```
...
DT::datatable(metadata_kongsfjorden, rownames = FALSE, filter = "top", 
              ...
              options = list(
                pageLength = 5,
                autoWidth = TRUE,
                columnDefs = list(list(width = '200px', targets = c(11))),
                deferRender = TRUE,
                scrollX = 1000,
                scrollY = 400,
                scrollCollapse = TRUE,
