...
metadata_EU_arctic <- rbind(EU_GEBCO, EU_zooplankton, EU_ice, EU_YMER, EU_Codispoti, EU_protists, 
                            EU_NCEI_1989, EU_GRDC, EU_Popova, EU_ichtyo, EU_green_fjords, EU_PG)
```
...
metadata_isfjorden <- rbind(is_mooring_N, is_mooring_S, is_mooring_IFO, is_mooring_GFI_N, is_mooring_GFI_S, 
                            ...
                            is_met_radio, is_met_airport, is_met_pyramiden, is_social, is_AIS, is_PG, full_product_is)
```
...
full_product_stor <- data.frame(type = "FACE-IT",
                                ...
                                note = "This is the full combined data product.")
# Bind them together
metadata_stor <- rbind(ingle_cryo, ingle_CTD, ingle_plankton, stor_PG, full_product_stor)
```
...
young_prim_prod <- data.frame(type = "CTD",
                              ...
                              lat_range = NA,
                              depth_range = NA,
                              file_name = '<a onclick="alert(\'Not currently on pCloud\');">0 files</a>',
