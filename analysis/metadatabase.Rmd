...
```{r EU-arctic-table}
knitr::kable(data.frame(Category = c("Cryosphere", "Physical", "Physical"),
                        Driver = c("Sea-ice", "Air temp.", "SST"),
                        Why = c("", "", ""),
                        Reference = c("", "", ""))) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "responsive")) %>% 
  row_spec(1, background = "mintcream") %>% 
  row_spec(2:3, color = "black", background = "skyblue")
```
...
```{r svalbard-table}
knitr::kable(data.frame(Category = c(""),
                        Driver = c(""),
                        Why = c(""),
                        Reference = c(""))) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "responsive")) #%>% 
...
sval_tidal_glacier_front <- data.frame(data_name = "Tidal glacier front",
                                       date_range = "2015 to 2019", #date_min = 2015, date_max = 2019,
                                       lon_range = "9 to 36", #lon_min = 9, lon_max = 36, 
                                       lat_range = "76 to 81", #lat_min = 76, lat_max = 81,
                                       depth_range = NA, #depth_min = NA, depth_max = NA,
...
```{r isfjorden-table}
knitr::kable(data.frame(Category = c("Social", "Social"),
                        Driver = c("Fish landings",
                                   "Tourism arrivals"),
                        Why = c("Alters top down trophic pressure.",
  ...
  # row_spec(8, background = "#F6EA7C") %>% 
  # row_spec(9:10, background = "#A2ED84") %>% 
  row_spec(1:2, background = "#F48080")
  # column_spec(popover = )
```
