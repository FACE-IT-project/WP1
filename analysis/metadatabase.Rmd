...
```{r isfjorden-table}
knitr::kable(data.frame(Category = c("Cryosphere", "Biological", "Social", "Social"),
                        ...
                        Reference = c("Muckenhuber et al. (2016)", "Delpech et al (2021)", 
                                      "", ""))) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "responsive")) %>% 
  row_spec(1, background = "mintcream") %>%
  # row_spec(4:7, color = "black", background = "skyblue") %>%
  # row_spec(8, background = "#F6EA7C") %>%
  row_spec(2, background = "#A2ED84") %>%
  row_spec(3:4, background = "#F48080")
  # column_spec(popover = )
```
