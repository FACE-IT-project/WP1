...
# Mooring IFO
por_mooring_IFO <- data.frame(data_name = "Mooring: temperature, salinity, O2, velocity (U, V)",
                             date_range = "2016 to 2017",
                             lon_range = "15.33116", lat_range = "78.247416",
                             depth_range = "0 to 60",
                             file_name = '<a onclick="alert(\'mooring_IFO: IFO1617.nc, IFO1617_ADCP.nc\');">1 folder, 2 files</a>',
...
# Mooring data from outer Isfjorden
por_mooring_outer <- data.frame(data_name = "Mooring: temperature, salinity, O2, velocity (U, V)",
                             date_range = "2007 to 2008",
                             lon_range = "14.41716", lat_range = "78.1383",
                             depth_range = "220",
                             file_name = '<a onclick="alert(\'IS0708.nc\');">1 file</a>',
...
# Bind them together
metadata_porsangerfjorden <- rbind(por_mooring_IFO, por_mooring_outer)
```
