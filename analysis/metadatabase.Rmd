...
# GFI mooring data
# https://sios-svalbard.org/metsis/search?fulltext=gfi&start_date=&end_date=&is_parent=All
...
# Mouth mooring GFI - NB: This needs more work
is_mooring_GFI <- data.frame(type = "Mooring",
                             ...
                             URL = '<a target="_blank" rel="noopener noreferrer" href="ftp://ftp.nmdc.no/nmdc/UIB/Currents/moorings/SV_201508_Isfjorden/">SIOS</a>',
                             reference = '<a onclick="alert(\'No reference provided.\');">NA</a>',
                             note = NA)
...
# Bind them together
metadata_isfjorden <- rbind(is_mooring_N, is_mooring_S, is_mooring_IFO, is_mooring_GFI, is_CO2_tempelfjorden, is_met_station,
