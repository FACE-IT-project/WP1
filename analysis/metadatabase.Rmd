...
young_air_pCO2 <- data.frame(type = "CTD",
                             ...
                             lat_range = "74.47",
                             depth_range = NA,
                             file_name = '<a onclick="alert(\'Zackenberg_Data_Water_column_CTD_measurements.csv\');"1 file</a>',
...
# Bind them together
metadata_young_sound <- rbind(young_CTD_water)
```
...
```{r nuup-meta-data}
# Air pCO2 data
nuup_air_pCO2 <- data.frame(type = "CTD",
                             data_name = "pCO2 (air)",
                             date_range = "2006 to 2016",
                             lon_range = "-20.57",
                             lat_range = "74.47",
...
# Bind them together
metadata_nuup <- rbind(nuup_air_pCO2)
```
