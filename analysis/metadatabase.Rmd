...
EU_PG_CTD <- data.frame(type = "PANGAEA",
...
metadata_EU_arctic <- rbind(EU_GEBCO, EU_zooplankton, EU_ice, EU_YMER, EU_Codispoti, EU_protists, 
                            EU_NCEI_1989, EU_PG_CTD, EU_GRDC)
```
...
sval_glacier_area <- data.frame(type = "",
                                ...
                                lat_range = "76 to 81",
                                depth_range = NA,
                                file_name = '<a onclick="alert(\'glacier_area/\');">1 folder</a>',
...
sval_fast <- data.frame(type = "",
                        ...
                        depth_range = NA,
                        file_name = '<a onclick="alert(\'svalbard_fastice_persistency_tiffs.zip\');">1 file</a>',
