...
This document is designed to satisfy D1.2 for the Horizon2020 project [FACE-IT](https://www.face-it-project.eu/). The interactive tables contain the meta-database for the datasets identified to contain the key drivers of change in fjord and adjacent coastal socio-ecological systems of the seven FACE-IT study sites ([D1.1](https://face-it-project.github.io/WP1/key_drivers.html)). The datasets identified within this document will be used for the completion of a review article on past and future changes of key drivers in and around the FACE-IT study sites ([D1.3](https://face-it-project.github.io/WP1/review.html)). The meta-database has been broken up into the different sites for convenience. With the exception that the first table contains data that span the entire European Arctic, as this is the broadest area of interest for FACE-IT, and there is a table dedicated to data that span all of Svalbard.
...
EU_green_fjords <- data.frame(type = "CTD",
                              ...
                              date_range = "2018",
                              lon_range = "-27.5 to -18.8",
                              lat_range = "68.5 to 73.8",
                              depth_range = "0 to 513",
...
metadata_EU_arctic <- rbind(EU_GEBCO, EU_zooplankton, EU_ice, EU_YMER, EU_Codispoti, EU_protists, 
                            EU_NCEI_1989, EU_GRDC, EU_Popova, EU_icthyo, EU_green_fjords, EU_PG)
```
...
kong_mooring_SAMS <- data.frame(type = "Mooring",
                                ...
                                lon_range = "11.81 to 11.82", 
                                lat_range = "78.95 to 78.96", 
                                depth_range = "20 to 220",
...
kong_NOAA <- data.frame(type = "Remote",
                        ...
                        date_range = "1982 to 2020",
                        lon_range = "10.125 to 12.125", 
                        lat_range = "78.625 to 79.375",
                        depth_range = NA,
...
kong_CCI <- data.frame(type = "Remote",
                       data_name = "Sea temperature: surface",
                       date_range = "1982 to 2020",
                       lon_range = "9.525 to 13.975", 
                       lat_range = "78.025 to 79.475",
                       depth_range = NA,
...
kong_SOCAT <- data.frame(type = "Synthesis",
                         ...
                         date_range = "2008 to 2019",
                         lon_range = "11.001 to 12.282",
                         lat_range = "78.904 to 79.099",
                         depth_range = NA,
...
full_product_kong <- data.frame(type = "Combined",
                                data_name = "Many",
                                date_range = "1871 to 2021",
                                lon_range = "4.18 to 13.15", 
                                lat_range = "78.78 to 79.15",
                                depth_range = "-60 to 3052",
...
is_NOAA <- data.frame(type = "Remote",
                      data_name = "Sea temperature: surface",
                      date_range = "1982 to 2020",
                      lon_range = "10.125 to 17.875",
                      lat_range = "77.125 to 78.875",
                      depth_range = NA,
...
is_CCI <- data.frame(type = "Remote",
                     data_name = "Sea temperature: surface",
                     date_range = "1982 to 2020",
                     lon_range = "10.025 to 17.975", 
                     lat_range = "77.025 to 78.975",
                     depth_range = NA,
...
is_SOCAT <- data.frame(type = "Synthesis",
                       data_name = "Partial pressure of CO2",
                       date_range = "1999 to 2020",
                       lon_range = "12.970 to 16.465",
                       lat_range = "78.000 to 78.565",
                       depth_range = "0 to 5",
...
is_GLODAP <- data.frame(type = "Bottle",
                        ...
                        date_range = "1980 to 1999",
                        lon_range = "14.000 to 16.665",
                        lat_range = "78.133 to 78.567",
                        depth_range = "11 to 363",
...
stor_PAR <- data.frame(type = "Cruise",
                       ...
                       date_range = "2020",
                       lon_range = "16.5 to 21.5",
                       lat_range = "76 to 78.5",
                       depth_range = NA,
                       ...
                       note = "The light data in these files are in raw wave length spectra so are not included in the final FACE-IT data compilation.")

# NOAA OISST
stor_NOAA <- data.frame(type = "Remote",
                        data_name = "Sea temperature: surface",
                        date_range = "1982 to 2020",
                        lon_range = "17.375 to 21.875", 
                        lat_range = "77.125 to 78.375",
                        depth_range = NA,
...
stor_CCI <- data.frame(type = "Remote",
                       data_name = "Sea temperature: surface",
                       date_range = "1982 to 2020",
                       lon_range = "17.025 to 21.975", 
                       lat_range = "77.025 to 78.475",
                       depth_range = NA,
...
stor_SOCAT <- data.frame(type = "Synthesis",
                         data_name = "Partial pressure of CO2",
                         date_range = "1999 to 1999",
                         lon_range = "18.266 to 20.688",
                         lat_range = "77.332 to 78.130",
                         depth_range = "0 to 5",
...
stor_GLODAP <- data.frame(type = "Bottle",
                          data_name = "All chemistry drivers; seawater temperature: surface, mid, bottom; salinity",
                          date_range = "1999 to 2002",
                          lon_range = "18.000 to 21.143",
                          lat_range = "77.34 to 78.13",
                          depth_range = "3 to 177",
...
stor_PG <- data.frame(type = "PANGAEA",
                      data_name = "Many",
                      date_range = "1871 to 2016",
                      lon_range = "17.3 to 21.6", 
                      lat_range = "77.4 to 78.1",
                      depth_range = "-614 to 185",
...
DT::datatable(metadata_stor, rownames = FALSE, escape = FALSE, colnames = DT_cols,
              caption = "All data files in this table are found within '~/pCloudDrive/FACE-IT_data/storfjorden/'.")
```
...
young_NOAA <- data.frame(type = "Remote",
                         data_name = "Sea temperature: surface",
                         date_range = "1982 to 2020",
                         lon_range = "-22.375 to -17.625",
                         lat_range = "73.125 to 75.375",
                         depth_range = NA,
...
young_CCI <- data.frame(type = "Remote",
                        data_name = "Sea temperature: surface",
                        date_range = "1982 to 2020",
                        lon_range = "-22.475 to -17.525",
                        lat_range = "73.025 to 75.475",
                        depth_range = NA,
...
young_PG <- data.frame(type = "PANGAEA",
                       ...
                       lon_range = "-22.1 to -19.9", 
                       lat_range = "74.2 to 74.6",
...
DT::datatable(metadata_young_sound, rownames = FALSE, escape = FALSE, colnames = DT_cols,
              caption = "All data files in this table are found within '~/pCloudDrive/FACE-IT_data/young_sound/'.")
```
...
disko_NOAA <- data.frame(type = "Remote",
                         data_name = "Sea temperature: surface",
                         date_range = "1982 to 2020",
                         lon_range = "-55.875 to -50.875",
                         lat_range = "68.125 to 70.875",
                         depth_range = NA,
...
disko_CCI <- data.frame(type = "Remote",
                        data_name = "Sea temperature: surface",
                        date_range = "1982 to 2020",
                        lon_range = "-55.975 to -49.975", 
                        lat_range = "68.025 to 70.975",
                        depth_range = NA,
...
disko_SOCAT <- data.frame(type = "Synthesis",
                          data_name = "Partial pressure of CO2",
                          date_range = "2015 to 2019",
                          lon_range = "-54.186 to -52.869",
                          lat_range = "68.220 to 68.750",
                          depth_range = NA,
...
disko_GLODAP <- data.frame(type = "Bottle",
                           data_name = "All chemistry drivers; seawater temperature: surface, mid, bottom; salinity",
                           date_range = "2004 to 2015",
                           lon_range = "-55.495 to -51.228",
                           lat_range = "68.382 to 69.496",
                           depth_range = "1 to 867",
...
disko_PG <- data.frame(type = "PANGAEA",
                       ...
                       lon_range = "-55.5 to -49.6", 
                       lat_range = "68.2 to 70.5",
                       depth_range = "0 to 899",
...
DT::datatable(metadata_disko_bay, rownames = FALSE, escape = FALSE, colnames = DT_cols,
              caption = "All data files in this table are found within '~/pCloudDrive/FACE-IT_data/disko_bay/'.")
```
...
nuup_NOAA <- data.frame(type = "Remote",
                        data_name = "Sea temperature: surface",
                        date_range = "1982 to 2020",
                        lon_range = "-53.375 to -51.375",
                        lat_range = "63.625 to 64.875",
                        depth_range = NA,
...
nuup_CCI <- data.frame(type = "Remote",
                       data_name = "Sea temperature: surface",
                       date_range = "1982 to 2020",
                       lon_range = "-53.475 to -49.775", 
                       lat_range = "63.525 to 64.975",
                       depth_range = NA,
...
nuup_SOCAT <- data.frame(type = "Synthesis",
                         data_name = "Partial pressure of CO2",
                         date_range = "2015 to 2020",
                         lon_range = "-53.171 to -51.637",
                         lat_range = "64.010 to 64.800",
                         depth_range = NA,
...
nuup_PG <- data.frame(type = "PANGAEA",
                      ...
                      lon_range = "-53.3 to -49.6", 
                      lat_range = "64.0 to 64.8",
                      depth_range = "-39 to 599",
...
por_NOAA <- data.frame(type = "Remote",
                       data_name = "Sea temperature: surface",
                       date_range = "1982 to 2020",
                       lon_range = "23.625 to 27.875",
                       lat_range = "70.375 to 71.875",
                       depth_range = NA,
...
por_CCI <- data.frame(type = "Remote",
                      data_name = "Sea temperature: surface",
                      date_range = "1982 to 2020",
                      lon_range = "23.525 to 27.975", 
                      lat_range = "69.975 to 71.975",
                      depth_range = NA,
...
por_SOCAT <- data.frame(type = "Synthesis",
                        data_name = "Partial pressure of CO2",
                        date_range = "2016 to 2020",
                        lon_range = "24.500 to 27.000",
                        lat_range = "70.293 to 71.200",
                        depth_range = "0 to 5",
