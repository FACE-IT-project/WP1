...
por_NorKyst <- data.frame(data_name = "Met station: air temperature (2m), air presure (sea level; 2m), wind (speed, direction; 10m), relative humidity",
...
# Bind them together
metadata_porsangerfjorden <- rbind(por_fish_bio, por_benthos_bio)
```
