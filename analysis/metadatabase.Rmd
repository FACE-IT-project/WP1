...
# Combine
metadata_EU_arctic <- rbind(EU_GEBCO, EU_zooplankton, EU_ice, EU_YMER, EU_Codispoti, EU_protists, EU_NCEI_1989, EU_GRDC)
```
...
metadata_kongsfjorden <- rbind(kong_sea_ice_inner, kong_zoo_data, kong_protist_nutrient_chla, kong_CTD_database, 
                               kong_CTD_CO2, kong_glacier_info, kong_weather_station, kong_PAR_secchi)
```
