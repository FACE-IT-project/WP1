...
# Unknown data
# test <- read_tsv("~/pCloudDrive/FACE-IT_data/kongsfjorden/unentered/2009-2013-pigments-api-v1.tsv")
# test <- tidync("~/pCloudDrive/FACE-IT_data/isfjorden/mooring_N/IN1516.nc") %>% 
  # activate("D2") %>% 
  # hyper_tibble()
# ncdump::NetCDF("~/pCloudDrive/FACE-IT_data/isfjorden/mooring_N/IN1516.nc")$variable$longname

# Bind them together
metadata_isfjorden <- rbind(is_mooring_N, is_mooring_S, is_CO2_tempelfjorden, is_met_station)
```
