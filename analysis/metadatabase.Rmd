...
meta_proc <- function(site_choice){
  ...
  res <- res_site |> 
    ...
    mutate(pub_author = case_when(grepl("Norwegian Polar Institute", citation) ~ "NPI",
                                  ...
                                  grepl("Statistics Greenland", citation) ~ "Statistics Greenland",
                                  grepl("Anonymous \\(20", citation) ~ "Anonymous",
                                  grepl("MarineBasis|ClimateBasis|GlacioBasis|Greenland Ecosystem Monitoring Programme", citation) ~ "GEM",
