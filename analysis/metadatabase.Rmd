...
DT::datatable(metadata_EU_arctic, rownames = FALSE, filter = "top", options = list(pageLength = 5, scrollX = T),
              caption = "Note that all files in this table are found within '~/pCloudDrive/FACE-IT_data/EU_arctic/'.")
```
...
DT::datatable(metadata_svalbard, rownames = FALSE, filter = "top", options = list(pageLength = 5, scrollX = T), 
              caption = "Note that all data files in this table are found within '~/pCloudDrive/FACE-IT_data/svalbard/'.")
```
...
DT::datatable(metadata_kongsfjorden, rownames = FALSE, filter = "top", options = list(pageLength = 5, scrollX = T), 
              caption = "Note that all data files in this table are found within '~/pCloudDrive/FACE-IT_data/kongsfjorden/'.")
```
