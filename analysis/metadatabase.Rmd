...
# EU_Popova <- "Arctic_model_output_acid.dat"
...
kong_PG <- data.frame(type = "PANGAEA",
                      ...
                      file_name = '<a onclick="alert(\'pg_kong_ALL.csv; pg_kong_ALL.RData\');">2 files</a>',
                      ...
                      note = "This is a combination of all PANGAEA data.")
...
full_product_kong <- data.frame(type = "Full",
                                ...
                                file_name = '<a onclick="alert(\'full_product_kong.csv; full_product_kong.RData\');">2 files</a>',
...
metadata_kongsfjorden <- rbind(kong_sea_ice_inner, kong_zoo_data, kong_protist_nutrient_chla, kong_CTD_database, 
                               kong_CTD_CO2, kong_glacier_info, kong_weather_station, kong_PG, full_product_kong)
```
...
# CO2 station at IsA
is_CO2_IsA <- data.frame(type = "CTD",
                         data_name = "Sea temperature; salinity; TA; pH; EP TA",
                         date_range = "2015 to 2017",
...
is_Chla_IsA <- data.frame(type = "Niskin",
                          data_name = "ChlA",
                          date_range = "2011 to 2019",
                          lon_range = "15.52992", lat_range = "78.26105",
...
is_PG <- data.frame(type = "PANGAEA",
                    ...
                    file_name = '<a onclick="alert(\'pg_is_ALL.csv\');">2 files</a>',
...
full_product_is <- data.frame(type = "Full",
                              ...
                              lat_range = "78.0300 to 78.7022",
                              depth_range = "-754 to 415.8",
                              file_name = '<a onclick="alert(\'full_product_kong.csv; full_product_kong.RData\');">1 file, 2 formats</a>',
                              URL = '<a onclick="alert(\'full_product_kong.csv/.RData\');">See URL column</a>',
                              reference = '<a onclick="alert(\'full_product_kong.csv/.RData\');">See citation column</a>',
                              note = "This is the full combined data product.")

# Bind them together
metadata_isfjorden <- rbind(is_mooring_N, is_mooring_S, is_mooring_IFO, is_mooring_GFI_N, is_mooring_GFI_S, is_CO2_tempelfjorden, 
                            is_CO2_IsA, is_Chla_IsA, is_met_radio, is_met_airport, is_met_pyramiden, is_PG, full_product_is)
```
...
ingle_PG <- data.frame(type = "PANGAEA",
                       ...
                       depth_range = NA,
                       file_name = '<a onclick="alert(\'pg_ingle_ALL.csv; pg_ingle_ALL.RData\');">2 files</a>',
...
full_product_ingle <- data.frame(type = "Full",
                                 ...
                                 lat_range = "77.9 to 78.0",
                                 depth_range = NA,
                                 file_name = '<a onclick="alert(\'full_product_ingle.csv; full_product_ingle.RData\');">2 files</a>',
                                 ...
                                 note = "This is the full combined data product.")
# Bind them together
metadata_ingle <- rbind(ingle_PG, full_product_ingle)
```
...
young_PG <- data.frame(type = "PANGAEA",
                       ...
                       file_name = '<a onclick="alert(\'pg_young_ALL.csv; pg_young_ALL.RData\');">2 files</a>',
...
full_product_young <- data.frame(type = "Full",
                                 ...
                                 lat_range = "74.2137 to 74.6025",
                                 depth_range = "-1044 to 344",
                                 file_name = '<a onclick="alert(\'full_product_young.csv; full_product_young.RData\');">2 files</a>',
...
disko_PG <- data.frame(type = "PANGAEA",
                       ...
                       file_name = '<a onclick="alert(\'pg_disko_ALL.csv; pg_disko_ALL.RData\');">2 files</a>',
...
full_product_disko <- data.frame(type = "Full",
                                 ...
                                 lat_range = "68.22 to 70.50",
                                 depth_range = "0 to 899.1",
                                 file_name = '<a onclick="alert(\'full_product_disko.csv; full_product_disko.RData\');">2 files</a>',
...
nuup_PG <- data.frame(type = "PANGAEA",
                      ...
                      file_name = '<a onclick="alert(\'pg_nuup_ALL.csv; pg_nuup_ALL.RData\');">2 files</a>',
...
full_product_nuup <- data.frame(type = "Full",
                                ...
                                lat_range = "64.01 to 64.80",
                                depth_range = "-39 to 599.1",
                                file_name = '<a onclick="alert(\'full_product_nuup.csv; full_product_nuup.RData\');">2 files</a>',
...
por_benthos_bio <- data.frame(type = "Survey",
                              data_name = "Benthos species biomass",
                              date_range = "2007 to 2016",
                              lon_range = "?", 
                              lat_range = "?",
                              depth_range = "?",
...
por_PG <- data.frame(type = "PANGAEA",
                     ...
                     file_name = '<a onclick="alert(\'pg_por_ALL.csv; pg_por_ALL.RData\');">2 files</a>',
...
full_product_por <- data.frame(type = "Full",
                               ...
                               lat_range = "70.0 to 71.2",
                               depth_range = "-285 to 310",
                               file_name = '<a onclick="alert(\'full_product_por.csv; full_product_por.RData\');">2 files</a>',
...
# Bind them together
metadata_porsangerfjorden <- rbind(por_mooring_GFI, por_fish_bio, por_benthos_bio, por_NorKyst, por_sea_ice, por_hydro, por_PG, full_product_por)
```
