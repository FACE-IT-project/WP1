...
is_Chla_IsA <- data.frame(type = "CTD",
                          data_name = "ChlA",
                          ...
                          URL = '<a onclick="alert(\'https://sios-svalbard.org/metsis/search?fulltext=isfjorden&start_date=&end_date=&is_parent=All\');">SIOS</a>',
                          reference = '<a onclick="alert(\'No reference provided.\');">NA</a>',
                          note = NA)
