...
full_product_stor <- data.frame(type = "FACE-IT",
                                ...
                                note = "This is the full combined data product.")
# Bind them together
metadata_stor <- rbind(ingle_cryo, ingle_CTD, ingle_plankton, stor_PAR, stor_PG, stor_NOAA, stor_CCI, full_product_stor)
```
...
# Bind them together
metadata_disko_bay <- rbind(disko_CTD_water, disko_CTD_ChlA, disko_NOAA, disko_CCI, disko_PG, full_product_disko)
```
...
metadata_nuup <- rbind(nuup_phyto_abundance, nuup_CTD, nuup_Chla, nuup_prim_prod, nuup_phosphate, nuup_silicate,
                       nuup_NOAA, nuup_CCI, nuup_PG, full_product_nuup)
```
...
metadata_porsangerfjorden <- rbind(por_mooring_GFI, por_fish_bio, por_benthos_bio, por_NorKyst, por_sea_ice, 
                                   por_hydro, por_IMR_CTD, por_IMR_plankton, por_NOAA, por_CCI, por_PG, full_product_por)
```
