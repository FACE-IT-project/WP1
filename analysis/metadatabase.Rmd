...
stor_PAR <- data.frame(type = "Cruise",
                       data_name = "PAR; turbidity; Kd; salinity; seawater temperature: surface, mid, bottom, DOM",
                       date_range = "2020",
                       lon_range = "16.5 to 21.5",
                       lat_range = "76 to 78.5",
                       depth_range = NA,
                       file_name = '<a onclick="alert(\'Data currently under embargo until publication.\');">0 files</a>',
