...
metadata_young_sound <- rbind(young_air_pCO2, young_water_pCO2, young_CTD_bottom, young_CTD_water, 
                              ...
                              young_prim_prod, young_mooring_multi, young_NOAA, young_CCI, young_MASIE, young_PG, full_product_young)
```
...
# Bind them together
metadata_disko_bay <- rbind(disko_CTD_water, disko_CTD_ChlA, disko_NOAA, disko_CCI, disko_MASIE, disko_SOCAT, disko_GLODAP, 
