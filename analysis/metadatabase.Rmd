...
kong_PG <- data.frame(type = "See file",
                      data_name = "See file",
                      ...
                      reference = '<a onclick="alert(\'pg_kong_ALL.csv\');">See reference column</a>',
                      note = "This is a combined data product.")

# Fully combined product
full_product_kong <- data.frame(type = "See file",
                                data_name = "See file",
                                date_range = "1871-08-09 to 2020-10-04",
                                lon_range = "", 
                                lat_range = "",
                                ...
                                reference = '<a onclick="alert(\'full_product_kong.csv\');">See reference column</a>',
                                note = "This is a combined data product.")
...
metadata_kongsfjorden <- rbind(kong_sea_ice_inner, kong_zoo_data, kong_protist_nutrient_chla, kong_CTD_database, 
                               kong_CTD_CO2, kong_glacier_info, kong_weather_station, kong_PG)
```
