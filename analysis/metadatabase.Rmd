...
metadata_isfjorden <- rbind(is_mooring_N, is_mooring_S, is_mooring_IFO, is_mooring_GFI_N, is_mooring_GFI_S, 
                            ...
                            is_met_radio, is_met_airport, is_met_pyramiden, is_social, is_AIS, is_ship_arrivals,
...
full_product_stor <- data.frame(type = "FACE-IT",
                                ...
                                note = "This is the full combined data product.")
# Bind them together
metadata_stor <- rbind(ingle_cryo, ingle_CTD, ingle_plankton, stor_PAR, stor_PG, full_product_stor)
```
...
metadata_young_sound <- rbind(young_air_pCO2, young_water_pCO2, young_CTD_bottom, young_CTD_water, 
                              ...
                              young_prim_prod, young_PG, full_product_young)
```
...
# Bind them together
metadata_disko_bay <- rbind(disko_CTD_water, disko_CTD_ChlA, disko_PG, full_product_disko)
```
