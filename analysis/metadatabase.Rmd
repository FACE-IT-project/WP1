...
EU_GEBCO <- data.frame(type = "",
                       ...
                       file_name = '<a onclick="alert(\'Not currently hosted\');">1 file</a>',
...
EU_NCEI_1989 <- data.frame(type = "CTD",
                           ...
                           note = NA)
# EU PANGAEA CTD data
EU_PANGAEA_CTD <- data.frame(type = "CTD",
                             data_name = "Most drivers",
                             date_range = "1905 to 2018",
                             lon_range = "-170.8 to 177.6",
                             lat_range = "0 to 88",
                             depth_range = "0 to 4450",
                             file_name = '<a onclick="alert(\'pg_EU_ctd_all.csv\');">1 file</a>',
                             URL = '<a onclick="alert(\'Links provided per row of data.\');">PANGAEA</a>',
                             reference = '<a onclick="alert(\'References provided per row of data.\');">Many</a>',
                             note = "See the data file for links and references.")
...
metadata_EU_arctic <- rbind(EU_GEBCO, EU_zooplankton, EU_ice, EU_YMER, EU_Codispoti, EU_protists, 
                            EU_NCEI_1989, EU_PANGAEA_CTD, EU_GRDC)
```
...
# Dedicated PAR data
kong_PAR_secchi <- data.frame(type = "Secchi disk",
                              data_name = "PAR",
                              date_range = "2006",
                              lon_range = "13.5",
                              lat_range = "78.78",
                              depth_range = NA,
                              file_name = '<a onclick="alert(\'kong_PAR_secchi.csv\');">1 file</a>',
                              URL = '<a target="_blank" rel="noopener noreferrer" href="https://doi.org/10.1594/PANGAEA.860041">PANGAEA</a>',
                              reference = '<a onclick="alert(\'Woelfel, Jana; Schumann, Rhena; Leopold, Peter; Wiencke, Christian; Karsten, Ulf (2009): (Table 3) Underwater PAR intensities and Secchi depths measured close to the Ny Alesund harbour in Kongsfjorden (2006) under different weather conditions. PANGAEA, https://doi.org/10.1594/PANGAEA.860041, In supplement to: Woelfel, J et al. (2009): Microphytobenthic biomass along gradients of physical conditions in Arctic Kongsfjorden, Svalbard. Botanica Marina, 52(6), 573-583, https://doi.org/10.1515/BOT.2009.075\');">Woelfel et al. (2009)</a>',
                              note = NA)

# Field samples during carbonate chemistry experiment
kong_Comeau <- data.frame(type = "Bottle",
                          data_name = "Sea temperature; salinity; AT; DIC; pH; pCO2",
                          date_range = "2009-05-17 to 2009-06-02",
                          lon_range = "11.9 to 12.07", 
                          lat_range = "78.94 to 78.96",
                          depth_range = "0",
                          file_name = '<a onclick="alert(\'pg_kong_Comeau.csv\');">1 file</a>',
                          URL = '<a target="_blank" rel="noopener noreferrer" href="https://doi.org/10.1594/PANGAEA.744718">PANGAEA</a>',
                          reference = '<a onclick="alert(\'Comeau, Steeve; Jeffree, Ross; Teyssié, Jean-Louis; Gattuso, Jean-Pierre (2009): Seawater carbonate chemistry in Kongsfjorden, Svalbard, May 2009. PANGAEA, https://doi.org/10.1594/PANGAEA.744718, In: EPOCA Arctic experiment 2009 team (2009): EPOCA 2009 Svalbard benthic experiment. PANGAEA, https://doi.org/10.1594/PANGAEA.745083\');">Comeau et al. (2009)</a>',
                          note = NA)
...
metadata_kongsfjorden <- rbind(kong_sea_ice_inner, kong_zoo_data, kong_protist_nutrient_chla, kong_CTD_database, 
                               kong_CTD_CO2, kong_glacier_info, kong_weather_station, kong_PAR_secchi, kong_Comeau)
```
...
is_mooring_N <- data.frame(type = "Mooring",
                           ...
                           depth_range = "228",
                           file_name = '<a onclick="alert(\'mooring_N: IN1516.nc, IN1617.nc, IN1718.nc\');">1 folder, 3 files</a>',
...
is_mooring_IFO <- data.frame(type = "Mooring",
                             ...
                             URL = '<a onclick="alert(\'https://data.npolar.no/dataset/7718a106-5d13-42d9-bb79-1d2adf0f51c4\');">NPDC multiple</a>',
...
# Mooring data from outer Isfjorden
is_mooring_outer <- data.frame(type = "Mooring",
                               data_name = "Sea temperature; salinity; O2; current: velocity (U, V)",
                               date_range = "2007 to 2008",
                               lon_range = "14.41716", 
                               lat_range = "78.1383",
                               depth_range = "220",
                               file_name = '<a onclick="alert(\'IS0708.nc\');">1 file</a>',
                               URL = '<a target="_blank" rel="noopener noreferrer" href="https://sios-svalbard.org/metsis/display/metadata/?core=l1&datasetID=064a09b7-f590-4448-810e-3f287b182dd2&calling_results_page=https://sios-svalbard.org/results?page=2">SIOS</a>',
                               reference = '<a onclick="alert(\'No reference provided.\');">NA</a>',
                               note = NA)

# Mouth mooring GFI
is_mooring_GFI <- data.frame(type = "Mooring",
                             data_name = "Sea temperature; turbidity; current: direction, speed",
                             date_range = "2012 to 2013",
                             lon_range = "13.52211", lat_range = "78.06071",
                             depth_range = "50 to 182",
                             file_name = '<a onclick="alert(\'mooring_GFI: 0710_RCM_783_QC.nc, 0711_RCM_784_QC.nc, 1841_RCM_464_QC.nc\');">1 folder, 3 files</a>',
                             URL = '<a target="_blank" rel="noopener noreferrer" href="https://sios-svalbard.org/metsis/display/metadata/?core=l1&datasetID=SV_201209_A&calling_results_page=https://sios-svalbard.org/results?page=1">SIOS</a>',
                             reference = '<a onclick="alert(\'No reference provided.\');">NA</a>',
                             note = NA)
...
is_CO2_IsA <- data.frame(type = "CTD",
                         ...
                         file_name = '<a onclick="alert(\'Marine_CO2_system_data_at_the_IsA_Station_2015_to_2017.xlsx\');"1 file</a>',
                         URL = '<a target="_blank" rel="noopener noreferrer" href="https://sios-svalbard.org/metsis/display/metadata/?core=l1&datasetID=UNIS_MARINE_CO2_2019_2&calling_results_page=https://sios-svalbard.org/results?page=1">SIOS</a>',
                         reference = '<a onclick="alert(\'No reference provided.\');">NA</a>',
                         note = NA)
...
is_Chla_IsA <- data.frame(type = "CTD",
                          ...
                          file_name = '<a onclick="alert(\'mooring_GFI: IsA_Svalbard_Chlorophyll_A_2011_2019_10um.nc, IsA_Svalbard_Chlorophyll_A_2011_2019_GFF.nc\');">1 folder, 2 files</a>',
                          URL = '<a onclick="alert(\'https://sios-svalbard.org/metsis/display/metadata/?core=l1&datasetID=8d81280a-3876-11eb-9f85-934f5f03b0c4&calling_results_page=https://sios-svalbard.org/results?page=1        https://sios-svalbard.org/metsis/display/metadata/?core=l1&datasetID=8ce2a482-3876-11eb-9f85-934f5f03b0c4&calling_results_page=https://sios-svalbard.org/results?page=1\');">SIOS multiple</a>',
                          reference = '<a onclick="alert(\'No reference provided.\');">NA</a>',
                          note = NA)

# Meteorological station
is_met_station <- data.frame(type = "Met station",
...
# Unknown data
# test <- read_tsv("~/pCloudDrive/FACE-IT_data/kongsfjorden/unentered/2009-2013-pigments-api-v1.tsv")
# test <- tidync("~/pCloudDrive/FACE-IT_data/isfjorden/IS0708.nc") %>%
#   activate("D2") %>%
#   hyper_tibble()
# ncdump::NetCDF("~/pCloudDrive/FACE-IT_data/isfjorden/IS0708.nc")$variable$longname

# Bind them together
metadata_isfjorden <- rbind(is_mooring_N, is_mooring_S, is_mooring_IFO, is_mooring_outer, is_mooring_GFI, is_CO2_tempelfjorden, is_met_station,
                            is_CO2_IsA, is_Chla_IsA)
```
...
No data were found for Inglefieldbukta on any of the data portals identified in D1.1.
...
# Bind them together
metadata_disko_bay <- rbind(disko_CTD_water)
```
...
# Bind them together
metadata_porsangerfjorden <- rbind(por_fish_bio, por_benthos_bio, por_NorKyst)
```
