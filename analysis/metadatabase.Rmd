...
metadata_kongsfjorden <- rbind(kong_sea_ice_inner, kong_zoo_data, kong_protist_nutrient_chla, kong_CTD_database, 
                               ...
                               kong_macroalgae, kong_benthic, kong_ship_arrivals, kong_NOAA, kong_PG, full_product_kong)
```
...
full_product_stor <- data.frame(type = "FACE-IT",
                                ...
                                note = "This is the full combined data product.")
# Bind them together
metadata_stor <- rbind(ingle_cryo, ingle_CTD, ingle_plankton, stor_PAR, stor_PG, stor_NOAA, full_product_stor)
```
...
metadata_young_sound <- rbind(young_air_pCO2, young_water_pCO2, young_CTD_bottom, young_CTD_water, 
                              ...
                              young_prim_prod, young_NOAA, young_PG, full_product_young)
```
...
# Bind them together
metadata_disko_bay <- rbind(disko_CTD_water, disko_CTD_ChlA, disko_NOAA, disko_PG, full_product_disko)
```
...
metadata_nuup <- rbind(nuup_phyto_abundance, nuup_CTD, nuup_Chla, nuup_prim_prod, nuup_phosphate, nuup_silicate,
                       nuup_NOAA, nuup_PG, full_product_nuup)
```
