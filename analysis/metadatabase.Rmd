...
kong_PG <- data.frame(type = "PANGAEA",
                      ...
                      file_name = '<a onclick="alert(\'pg_kong_ALL.csv\');">1 file</a>',
                      URL = '<a onclick="alert(\'pg_kong_ALL.csv\');">See URL column</a>',
                      reference = '<a onclick="alert(\'pg_kong_ALL.csv\');">See citation column</a>',
...
full_product_kong <- data.frame(type = "Full",
                                ...
                                lat_range = "",
                                depth_range = "",
                                file_name = '<a onclick="alert(\'full_product_kong.csv\');">1 file</a>',
                                URL = '<a onclick="alert(\'full_product_kong.csv\');">See URL column</a>',
                                reference = '<a onclick="alert(\'full_product_kong.csv\');">See citation column</a>',
