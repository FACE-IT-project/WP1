...
* The usefulness of the physical in situ data is not abundantly clear given the more complete models
* The chemical and biological in situ data may be a more important area of focus
...
Dynamically, Porsangerfjord isn’t different form any other fjord. The similarities are with fjords of same shape (large size, large sill depth or no sill) and with a stratified coastal ocean which provides a lot of baroclinic forcing = good water exchange. Ecologically the Porsangerfjord or the fjords in the Arctic are less similar than fjords further south as to temperature and light conditions especially.
__End__
