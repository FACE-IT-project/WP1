...
# Human presence in Svalbard{.tabset}
***

## Pop

![](assets/plot_pop.png){ width=100% }

## Tourists

![](assets/plot_arrival.png){ width=100% }

## Nights

![](assets/plot_guest.png){ width=100% }
...
![Vader et al. (In prep)](assets/plot_ChlA.png){ width=100% }
...
![](assets/plot_cryo.png){ width=100% }
