...
This website was created for D1.1 of the [Horizon2020](https://ec.europa.eu/programmes/horizon2020/en/home) project [FACE-IT](https://www.face-it-project.eu/).
...
```{r}
knitr::kable(data.frame(Category = "Chemistry",
                        Driver = c("carbonate chemistry", "nutrients")), 
             caption = "Table 3: The key chemistry drivers of changes for Arctic fjords.") %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "responsive")) %>% 
  # row_spec(1:3, background = "mintcream") #%>% # Cryosphere
  # row_spec(1:3, color = "black", background = "skyblue") #%>% # Physical
  row_spec(1:2, background = "#F6EA7C") #%>% # Chemistry
  # row_spec(30:36, background = "#A2ED84") %>% # Biology
  # row_spec(37:42, background = "#F48080") # Social
```

# <span style="background:#A2ED84"> Biology</span>
...
```{r}
knitr::kable(data.frame(Category = "Biology",
                        Driver = c("primary production", "biomass", "species richness")), 
             caption = "Table 4: The key biology drivers of changes for Arctic fjords.") %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "responsive")) %>% 
  # row_spec(1:3, background = "mintcream") #%>% # Cryosphere
  # row_spec(1:3, color = "black", background = "skyblue") #%>% # Physical
  # row_spec(1:2, background = "#F6EA7C") #%>% # Chemistry
  row_spec(1:3, background = "#A2ED84") #%>% # Biology
  # row_spec(37:42, background = "#F48080") # Social
```

# <span style="background:#F48080"> Social</span>
