...
## Cryosphere
if(!exists("query_Cryosphere")){
  # Coastal ice; Fast ice; Sea ice
...
if(!exists("query_ALL")) query_ALL <- rbind(query_Meta, query_Cryosphere, query_Physical, 
                                            query_Chemistry, query_Biology, query_Social) %>% distinct()
