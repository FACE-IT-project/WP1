...
- north of 60°N: 1.6751e+07 km2 or `r 100  * 1.6751e+07 / 361132000`% of the global ocean.
- north of 75°N: 7.11213e+06 km2 or `r 100  * 7.11213e+06 / 361132000`% of the global ocean.


```{r read socat, message=FALSE, warning=FALSE}
socat <- data.table::fread(file = paste0(pCloud_path, "FACE-IT_data/socat/SOCATv2020.tsv"), select = c("yr", "mon", "day", "longitude [dec.deg.E]", "latitude [dec.deg.N]", "pCO2water_SST_wet [uatm]"), skip = 6362, nrows = Inf, fill = TRUE)
...
* `r nrow(socat_arctic_60)`, or `r 100*nrow(socat_arctic_60)/nrow(socat_all)`%, in the Arctic Ocean (North of 60°N). 
* `r nrow(socat_arctic_75)`, or `r 100*nrow(socat_arctic_75)/nrow(socat_all)`%, in the Arctic Ocean (North of 75°N). 
...
* `r nrow(glodap_arctic_60)`, or `r 100*nrow(glodap_arctic_60)/nrow(glodap_all)`%, in the Arctic Ocean (North of 60°N)
* `r nrow(glodap_arctic_75)`, or `r 100*nrow(glodap_arctic_75)/nrow(glodap_all)`%, in the Arctic Ocean (North of 75°N). 
